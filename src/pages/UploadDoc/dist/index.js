...
function handleEditorChange(_a) {
        ...
        React.createElement(antd_1.Form, { name: "basic", onFinish: onFinish, onFinishFailed: onFinishFailed, className: index_less_1["default"].uploaderFrom },
            ...
            React.createElement("div", { className: index_less_1["default"].mdEditorClass },
                React.createElement(antd_1.Form.Item, { name: "doctext", noStyle: true, valuePropName: "text" },
                    React.createElement(react_markdown_editor_lite_1["default"], { style: { height: '100%' }, renderHTML: function (text) { return mdParser.render(text); }, onChange: handleEditorChange }))),

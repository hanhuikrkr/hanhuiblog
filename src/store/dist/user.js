...
var baseAction_1 = require("../utils/baseAction");
var mobx_1 = require("mobx");
var urls = require("../constant/urls");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.post(urls.API_USR_LOGIN, params)];
                    case 1:
                        r = _a.sent();
                        if (r) {
                            mobx_1.runInAction(function () {
                                if (r.data && r.code === 200) {
                                    if (params.remember)
                                        token_js_1["default"].saveUser(r.data);
                                    _this.usr = r.data[0];
                                    console.log("userStore", _this.usr);
                                    antd_1.message.success(r.msg);
